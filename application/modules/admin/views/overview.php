          ...
          <div class="card card-stats">
            ...
            <div class="card-body">
              ...
              <p class="mt-3 mb-0 text-sm">
                ...
                <span class="text-nowrap text-dark">Jumlah produk yang tersedia</span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">
                    <font color="black">Pelanggan</font>
                  </h5>
              ...
              <p class="mt-3 mb-0 text-sm">
                <span class="text-primary mr-2"><i class="fa fa-arrow-up"></i></span>
                <span class="text-nowrap text-dark">Pelanggan yang terdaftar</span>
              </p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              ...
              <p class="mt-3 mb-0 text-sm">
                <span class="text-primary mr-2"><i class="fa fa-arrow-up"></i></span>
                <span class="text-nowrap text-dark">Jumlah pesanan diterima</span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">
                    <font color="black">Pendapatan</font>
                  </h5>
              ...
              <p class="mt-3 mb-0 text-sm">
                <span class="text-primary mr-2"><i class="fa fa-arrow-up"></i></span>
                <span class="text-nowrap text-dark">Total pendapatan</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-dark text-uppercase ls-1 mb-1">Ringkasan</h6>
              <h5 class="h3 text-dark mb-0">Penjualan</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-dark text-uppercase ls-1 mb-1">Ringkasan</h6>
              <h5 class="h3 text-dark mb-0">Pendapatan</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
